								...
								<ul><li><a href="index.html">Home</a></li>
									<li class="dropdown"> <a href="#">Features</a>
										<ul class="dropdown-menu">
                                            ...
                                            </li><li class="dropdown-submenu"><a href="#"><i class="fa fa-navicon"></i>Main Menu<span class="label label-danger">NEW</span></a>
                                                <ul class="dropdown-menu">
...
<li><a href="widgets.html"><i class="fa fa-th"></i>Widgets</a></li>
											...
											<li><a href="page-loaders.html"><i class="fa fa-spinner"></i>Page Loaders<span class="label label-danger">NEW</span></a></li>                                            <li class="dropdown-submenu"><a href="#"><i class="fa fa-expand"></i>Modal Auto Open<span class="label label-danger">NEW</span></a>
                                                <ul class="dropdown-menu">
...
<li> <a href="portfolio-no-page-title-sidebar.html">No Page Title - Sidebar</a> </li>
                                                    ...
                                                    </div> <div class="col-md-12 m-t-40 m-b-10">
		...
		<section id="page-title" data-parallax-image="images/parallax/5.jpg">
			<div class="container">
				<div class="page-title">
					<h1>Forms</h1>
					<span>Inspiration comes of working every day.</span> </div>
        ...
        <div class="row">
          <div class="col-md-4"> 
            ...
            <div class="widget  widget-contact-us" style="background-image: url('images/world-map-dark.png'); background-position: 50% 20px; background-repeat: no-repeat">
              <h4>About POLO</h4>
              <ul class="list-icon">
                <li><i class="fa fa-map-marker"></i> 795 Folsom Ave, Suite 600 <br>
                ...
                <li> <br>
                  <i class="fa fa-clock-o"></i>Monday - Friday: <strong>08:00 - 22:00</strong> <br>
